...
`
    Caused by: com.google.protobuf.Descriptors$DescriptorValidationException: amber.hitec_proto.setAngleCommand: "amber.DriverMsg" does not declare 70 as an extension number.
