...
public class Configuration {
    ...
    public Configuration(double lookahead, double iAlpha, double iTrack, double centreAcceleration, double maxLinearVelocity, int bezierSegmentsNumber, boolean pointsWithTime, double scale, int loopSleepTime) {
